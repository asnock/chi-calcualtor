function calculatePrice() {
    ...
    document.getElementById('customerFinalPrice').innerHTML = "<p style='color:red; margin-left: 10px;' >Стоимость :</p>"+ "<p style='margin-left: 20px; font-weight: bold; height: 175px;'>" + customerFinalPriceBeautiful + " грн.</p>";
}
